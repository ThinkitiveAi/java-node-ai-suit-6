  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-healthcare-100 via-primary-100 to-healthcare-200"></div>
        <div className="absolute top-0 left-0 w-full h-full">
          {[...Array(20)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 bg-healthcare-400/40 rounded-full animate-pulse-slow"
              style={{
